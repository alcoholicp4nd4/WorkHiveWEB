  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (response.success) {
        ...
        navigate(response.isAdmin ? '/admin-dashboard' : '/', { replace: true });
      } else {
...
<div className="absolute z-10 bg-black rounded-xl px-8 py-10 w-[90%] max-w-md text-white shadow-2xl">
  ...
  <div className="space-y-4">
    <div className="flex items-center border border-purple-400 rounded-md px-3 py-2 bg-neutral-900">
